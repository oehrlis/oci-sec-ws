...
- OCI Stack for the workshop: [oehrlis/oci-sec-ws](https://cloud.oracle.com/resourcemanager/stacks/create?tenant=trivadisbdsxsp&region=eu-frankfurt-1&zipUrl=https://code.oradba.ch/oci-sec-ws/others/oci-sec-ws_stack.zip)
